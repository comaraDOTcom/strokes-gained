...
export const config = {
  // Static assets that must load without a session: the sign-in page's artwork, and everything a
  // home-screen install fetches (manifest + icons).
  matcher: ['/((?!_next/static|_next/image|favicon.ico|icon.svg|apple-icon.png|icon-192.png|icon-512.png|manifest.webmanifest|golf-scene.svg).*)'],
};
